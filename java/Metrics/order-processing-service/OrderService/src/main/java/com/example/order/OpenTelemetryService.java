...
public class OpenTelemetryService {
    ...
    public OpenTelemetryService(ServiceConfiguration orderServiceConfiguration) {
        openTelemetrySdk = initializeOpenTelemetry(orderServiceConfiguration.getServiceName(), orderServiceConfiguration.getServiceVersion());
    };
    public OpenTelemetrySdk initializeOpenTelemetry(String serviceName, String serviceVersion) {
        ...
        // Create a resource for Order Service. This will be added to every metric for context.
