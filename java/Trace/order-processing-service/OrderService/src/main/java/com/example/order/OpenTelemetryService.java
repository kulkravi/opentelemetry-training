...
public class OpenTelemetryService {
    ...
    public OpenTelemetryService(ServiceConfiguration orderServiceConfiguration) {
        openTelemetrySdk = initializeOpenTelemetry(orderServiceConfiguration.getServiceName(), orderServiceConfiguration.getServiceVersion(), orderServiceConfiguration.getOtelCollectorTracesURL());
    };
